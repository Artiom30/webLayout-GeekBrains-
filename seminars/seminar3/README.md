...
## Pабота с макетом в Figma. 

## Создание блочный структуры страницы.
---

### Задание 1 (тайминг 30 минут)
1. Открыть макет сайта
https://www.figma.com/file/wBdyeMhgGCn3fKThaQ1yXG/Lan
ding_Page?node-id=217%3A2
2. Вам необходимо разбить представленную часть на блоки
3. Можно рисовать в макете, можно на картинки в paint
